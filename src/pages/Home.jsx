...
export default function Home() {
  return (
    <section className="flex min-h-[calc(100vh-8rem)] flex-col items-center justify-center px-5 py-12 text-center">
      <div className="max-w-3xl">
        <span className="text-sm font-black uppercase tracking-wide text-primary">
          React Workshop
        </span>

        <h1 className="mt-4 text-[clamp(2.5rem,6vw,5rem)] font-black leading-none tracking-normal text-secondary">
          Welcome to the shop
        </h1>
